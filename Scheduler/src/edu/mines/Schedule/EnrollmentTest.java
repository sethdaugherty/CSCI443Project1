...
public class EnrollmentTest extends TestCase {
	...
	private static CourseMeeting DEFAULT_ENROLLMENT_COURSE_MEETING = CourseMeetingTest.createMeeting();
	...
	public void testCreateEnrollment() {
		...
		assertEquals("CourseMeeting is incorrect", enrollment.getCourseMeeting(), DEFAULT_ENROLLMENT_COURSE_MEETING);
	}
