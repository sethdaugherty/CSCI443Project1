...
public class StudentTest extends TestCase {
	...
	public static Student createStudent() {
		Student student = new Student(DEFAULT_STUDENT_NAME, DEFAULT_STUDENT_CWID, DEFAULT_STUDENT_MAJORS);
		return student;
	}
	...
	public void testCreateStudent() {
		...
		assertEquals("Number of majors is incorrect", student.getMajor().size(), DEFAULT_STUDENT_MAJORS.size());
	}
